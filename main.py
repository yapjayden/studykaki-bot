    ...
    try:
        response = await gemini_client.aio.models.generate_content(
            ...
            config=types.GenerateContentConfig(
                ...
                # answer text (which surfaces as an empty response). We avoid
                # ThinkingConfig entirely — its thinking_budget field isn't
                # supported across all google-genai versions and crashes the
                # call on older ones.
